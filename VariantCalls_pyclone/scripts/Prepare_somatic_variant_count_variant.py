...
def main():
    ...
    print 'Patient\tTotal\tTotal_exonic\tGermline_Free\tGermline_Free_exonic\tRD\tRD_exonic\tminread\t%minread_exonic\tminVAF\tminVAF_exonic\tmincaller\t_mincaller_exonic'
