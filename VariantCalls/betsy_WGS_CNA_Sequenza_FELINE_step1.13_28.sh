...
betsy_run.py --environment coh_slurm --receipt betsy_WGS_CNA_Sequenza_step1_receipt.txt --num_cores 16 \
    ...
    --input BamFolder --input_file $prefix\_bam_13_28 \
    ...
    --input NormalCancerFile --input_file $prefix\_normal_cancer.13_19_20_22_28.txt \
    --output SequenzaResults --output_file $prefix\_cnv_sequenza_13_19_20_22_28 \
