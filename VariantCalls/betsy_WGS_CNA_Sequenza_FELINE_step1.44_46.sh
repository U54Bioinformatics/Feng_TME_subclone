...
betsy_run.py --environment coh_slurm --receipt betsy_WGS_CNA_Sequenza_step1_receipt.txt --num_cores 16 \
    ...
    --input BamFolder --input_file $prefix\_bam_44_46 \
    ...
    --input NormalCancerFile --input_file $prefix\_normal_cancer.44_45_46.txt \
    --output SequenzaResults --output_file $prefix\_cnv_sequenza_44_45_46 \
